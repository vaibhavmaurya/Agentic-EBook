...
def handler(event: dict, context: Any) -> dict:
    ...
    # TODO M4: call openai_runtime.run_writer_agent(validated_evidence, style_guide)
    result = {"topic_id": inp["topic_id"], "run_id": run_id, "draft_uri": None, "status": "STUB"}
    stage_completed(run_id, _STAGE, agent_name="writer", model_name="gpt-4o")
    return result
