...
def handler(event: dict, context: Any) -> dict:
    ...
    # TODO M4: call openai_runtime.run_verifier_agent(evidence_set)
    result = {"topic_id": inp["topic_id"], "run_id": run_id, "verified_uri": None, "status": "STUB"}
    stage_completed(run_id, _STAGE, agent_name="verifier", model_name="gpt-4o-mini")
    return result
