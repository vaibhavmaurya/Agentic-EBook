...
def handler(event: dict, context: Any) -> dict:
    ...
    # TODO M4: call openai_runtime.run_research_agent(research_plan)
    result = {"topic_id": inp["topic_id"], "run_id": run_id, "evidence_uri": None, "status": "STUB"}
    stage_completed(run_id, _STAGE, agent_name="research", model_name="gpt-4o")
    return result
